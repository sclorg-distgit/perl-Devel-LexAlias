%{?scl:%scl_package perl-Devel-LexAlias}

Name:           %{?scl_prefix}perl-Devel-LexAlias
Version:        0.05
Release:        22%{?dist}
...
# Module Runtime
BuildRequires:  %{?scl_prefix}perl(Devel::Caller) >= 0.03
...
%changelog
* Mon Jan 06 2020 Jitka Plesnikova <jplesnik@redhat.com> - 0.05-22
- SCL
